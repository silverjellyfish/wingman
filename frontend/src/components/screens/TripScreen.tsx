import svgPaths from "../imports/svg-ldsvj6tbv8";
...
function Group() {
  return (
    <div className="relative shrink-0 w-[66px] h-[28px]" data-name="Group">
      {/* Stacked avatars with overlapping effect */}
      ...
      <div className="absolute left-[38px] top-0 z-10">
        <Avatar2 />
      </div>
    </div>
  );
...
export default function TripScreen({ onNavigate }: TripScreenProps) {
  return (
