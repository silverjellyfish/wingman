import svgPaths from "../imports/svg-0x09f7aqgn";
...
function AcceptButton({ onAccept }: { onAccept: () => void }) {
  return (
    <button 
      onClick={onAccept}
      className="bg-neutral-50 box-border content-stretch flex items-center justify-center px-[16px] py-[10px] relative rounded-[6px] shrink-0 hover:bg-zinc-100 transition-colors" 
      data-name="Button"
    >
...
function Frame11({ onAccept }: { onAccept: () => void }) {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
...
function Option({ title, onAccept }: { title: string; onAccept: () => void }) {
  return (
    <div className="bg-zinc-800 relative rounded-[16px] shrink-0 w-full" data-name="Option">
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start pl-[12px] pr-[8px] py-[8px] relative w-full">
          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
            <div className="font-['Geist:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[16px] text-center text-neutral-50 text-nowrap tracking-[0.08px]">
              <p className="leading-none whitespace-pre">{title}</p>
            </div>
            <AcceptButton onAccept={onAccept} />
          </div>
          <Frame17 />
...
function Frame73({ onAccept }: { onAccept: () => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full max-h-[400px] overflow-y-auto">
      <Option title="Option 1 (recommended)" onAccept={onAccept} />
      <Option title="Option 2" onAccept={onAccept} />
      <Option title="Option 3" onAccept={onAccept} />
      <Option title="Option 4" onAccept={onAccept} />
      <Option title="Option 5" onAccept={onAccept} />
    </div>
  );
}

function Frame74({ onAccept }: { onAccept: () => void }) {
  return (
...
export default function GroupMatchingScreen({ onNavigate }: GroupMatchingScreenProps) {
  return (
