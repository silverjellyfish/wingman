import svgPaths from "./svg-nk032gd5fl";
    ...
    <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="flex flex-col justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-center pl-0 pr-[258.05px] py-0 relative size-full">
          <div className="flex flex-col font-['Geist:Medium',_sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[0px] text-nowrap text-zinc-400 tracking-[0.07px]">
            <p className="leading-none text-[14px] whitespace-pre">
...
export default function Trip10() {
  return (
    <div className="bg-[#16161b] relative rounded-[40px] size-full" data-name="Trip 10">
      <div className="flex flex-col items-center relative size-full">
