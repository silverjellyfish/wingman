import svgPaths from "./svg-ornxuce90z";
...
export default function Nav() {
  return (
    <div className="bg-[#28282d] relative rounded-[28px] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.25)] size-full" data-name="Nav">
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex items-center justify-between px-[48px] py-0 relative size-full">
          <Frame25 />
          <Frame26 />
          <Frame24 />
        </div>
