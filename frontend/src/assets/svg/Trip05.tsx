import svgPaths from "./svg-u5k97ttfo6";
...
function Button() {
  return (
    <div className="box-border content-stretch flex h-[40px] items-center justify-center pb-[10.5px] pt-[9.5px] px-[16px] relative rounded-[6px] shrink-0" data-name="Button">
...
function Button1() {
  return (
    <div className="bg-neutral-50 box-border content-stretch flex gap-[8px] h-[40px] items-center justify-center pb-[10.5px] pt-[9.5px] px-[12px] relative rounded-[6px] shrink-0" data-name="Button">
      <Frame6 />
...
function Frame51() {
  return (
    <div className="bg-zinc-800 box-border content-stretch flex flex-col gap-[16px] items-start p-[12px] relative rounded-[16px] shrink-0 w-[336px]">
      <Frame64 />
      <Frame50 />
    </div>
  );
...
export default function Trip05() {
  return (
